...
<script type="text/javascript">
	...
	var before_content = document.before_content.value;
	Editor.getContent() = before_content;
...
<div class="body">
	...
	-->
	<form name="tx_editor_form2" id="tx_editor_form2" accept-charset="utf-8">
		<table>
			<tr>
				<th>글번호</th>
				<td>${boardvo.seq}
		...
		<input type="hidden" name="before_content" id="before_content" value="${boardvo.content}">
	</form>
</div>
<!-- 에디터2 끝 -->
<!-- 에디터2 config 시작 -->
...
<script type="text/javascript">
	function saveContent() {
		// 유효성 검사는 생략 하겠음.
		tx_editor_form2.content.value = Editor.getContent();
		tx_editor_form2.action = "/khx/jsb/recommendEditEnd.action";
...
<script type="text/javascript">
	EditorJSLoader.ready(function (Editor) {
		...
		Editor.getCanvas().observeJob(Trex.Ev.__IFRAME_LOAD_COMPLETE, function() {
			Editor.modify({
				content: tx_editor_form2.before_content.value
			});
			new Editor(config3);
